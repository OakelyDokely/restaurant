...
class Ingredient(models.Model):
    ...
    quantity = models.DecimalField(decimal_places=1, verbose_name="Ingredient Quantity")
    price = models.DecimalField(decimal_places=2, verbose_name="Ingredient Price")

class MenuItem(models.Model):
    name = models.CharField(max_length=100, verbose_name='Menu Item Name')
    price = models.DecimalField(decimal_places=2, verbose_name='Menu Item Price')
...
class RecipeRequirement(models.Model):
    ...
    quantity = models.DecimalField(decimal_places=1, verbose_name="Required Quantity")

class Purchase(models.Model):
    customer_name = models.CharField(max_length=100, verbose_name='Customer Name')
    menu_item = models.ForeignKey(MenuItem, verbose_name='Purchased Menu Item')
